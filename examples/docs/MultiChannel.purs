...
multiChannel :: forall event payload. IsEvent event => Plus event => CancelCurrentAudio -> (Page -> Effect Unit) -> event PageAction -> Element event payload
multiChannel _ dpage _ = px ~~
