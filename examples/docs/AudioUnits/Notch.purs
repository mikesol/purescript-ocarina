...
import WAGS.Control (notch_, loopBuf, gain_)
...
<h2 id="notch">Notch filter</h2>
  ...
  [ fan (loopBuf buf pureOn)
      \b -> gain_ 0.2
        [ notch_ { frequency: 400.0, q: 30.0 } [ input b ]
        , notch_ { frequency: 880.0, q: 30.0 } [ input b ]
        , notch_ { frequency: 1200.0, q: 30.0 } [ input b ]
        , notch_ { frequency: 2000.0, q: 30.0 } [ input b ]
        , notch_ { frequency: 3000.0, q: 30.0 } [ input b ]
        ]
  ]
</code></pre>
  ...
  { notch: nut
      ( audioWrapper ev ccb (ctxAff >>= \ctx -> decodeAudioDataFromUri ctx "https://freesound.org/data/previews/320/320873_527080-hq.mp3")
          \buf -> run2_
            [ fan (loopBuf buf pureOn)
                \b -> gain_ 0.2
                  [ notch_ { frequency: 400.0, q: 1.0 } [ input b ]
                  , notch_ { frequency: 880.0, q: 5.0 } [ input b ]
                  , notch_ { frequency: 1200.0, q: 10.0 } [ input b ]
                  , notch_ { frequency: 2000.0, q: 20.0 } [ input b ]
                  , notch_ { frequency: 3000.0, q: 30.0 } [ input b ]
                  ]
            ]
      )
