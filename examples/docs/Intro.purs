...
px = Proxy :: Proxy """<div>
  ...
  <ul>
    <li>Wags sticks to vanilla PureScript primitives and patterns, which allows you to build powerful abstractions.</li>
