...
`}})()()(Q()(J)({reflectType:function(){return"periodic"}})({reflectSymbol:function(){return"periodic"}})),Qz=C(ua),Kz=Nt(dt),Yz=Dl(sl(ar(wr()(St(St(Or)(_l(fl(Ku)))()()()({reflectSymbol:function(){return"spec"}}))(ll)()()()({reflectSymbol:function(){return"frequency"}})))($r()()))),jE=Ne(Oe(Ku)()(Xa)()(gi)),XE=Ne(Oe(yi)()(Qa)()(Xa)),QE=Ne(Oe(Ai)()(Ka)()(Qa)),KE=Ne(Oe(ki)()(hi)()(Ka)),Zz=at(),t5=function(){return D.value}(),YE=function(t){return function(r){return function(e){return Xz(t5)({periodic:$(bt(e)(t)(function(n){return Qz(void 0)})(function(n){return function(a){return ut(n)([Kz(.2)([Yz({frequency:140,spec:new G(jE(.1)(XE(.2)(QE(.3)(KE(.4)(Au)))),jE(.4)(XE(.3)(QE(.2)(KE(.1)(Au)))))})(Zz)])])}}))})}}};var e5=gt({reflectType:function(){return`<section>
...
`}})({reflectType:function(){return"@"}})()()(Y$(Y$(J)({reflectType:function(){return"txt"}})({reflectSymbol:function(){return"txt"}}))({reflectType:function(){return"ex2"}})({reflectSymbol:function(){return"ex2"}})),TJ=vu()(re({reflectSymbol:function(){return"slider"}})()()(pu({reflectSymbol:function(){return"startStop"}})()()()(re({reflectSymbol:function(){return"start"}})()()(re({reflectSymbol:function(){return"stop"}})()()(An)()())()())(An)()())()()),vk=$t(jt),mk=C(nt),Eu=A(Ct),SJ=Rr(jn),EJ=at(),FJ=hf()(Hv),$J=em(Vv),OJ=Nt(dt),Dk=Da(dt),dk=da()(wn),nO=wr(),aO=St(Or),uO={reflectSymbol:function(){return"q"}},oO={reflectSymbol:function(){return"frequency"}},iO=$r()(),Z$=Vo(fo(ar(nO(St(aO(zo)()()()(uO))(oo)()()()(oO)))(iO))),wJ=dl(Qb(ar(nO(St(aO(NT)()()()(uO))(Lb)()()()(oO)))(iO))),MJ=Bm(Rl)(T),Hm=yc(Rl),IJ=kt(Qo),PJ=kt(Ff),NJ=kt(Ef),RJ=kt(Of),LJ=yc(Lm),BJ=kt(wf),WJ=kt($f),qJ=dn(Yt)(Ue),UJ=hc(Kn),HJ=xn(Un),zJ=Hn(Gt)(T),VJ=kt(Se),tO=De(Ct),JJ=Dt(yn),bk=j(Ct),GJ=ot(it),rO=C(Yt),jJ=Mn(fe),XJ=Si(Ct),rs=or(vr),eO=mn(fe),QJ=me(Gt)(T),KJ=`module Main where
...
`}})({reflectType:function(){return"@"}})()()(Q()(J)({reflectType:function(){return"ai0"}})({reflectSymbol:function(){return"ai0"}})),R7=ur(Dr),L7=at(),B7=Nt(dt),es=Vo(fo(ar(wr()(St(St(Or)(zo)()()()({reflectSymbol:function(){return"q"}}))(oo)()()()({reflectSymbol:function(){return"frequency"}})))($r()()))),W7=function(){return D.value}(),mO=function(t){return function(r){return function(e){return N7(D.value)(W7)({ai0:$(bt(e)(t)(function(n){return lt(n)("https://freesound.org/data/previews/320/320873_527080-hq.mp3")})(function(n){return function(a){return ut(n)([ea(R7(a)(L7))(function(u){return function(i){return B7(.8)([es({frequency:400,q:1})([u]),es({frequency:880,q:5})([u]),es({frequency:1200,q:10})([u]),es({frequency:2e3,q:20})([u]),es({frequency:3e3,q:30})([u])])}})])}}))})}}};var U7=nr({reflectType:function(){return`<div>
  <pre><code>\\buf -> run2_
  [ fan1 (loopBuf buf bangOn)
      \\b _ -> gain_ 0.8
        $ 0 .. 40 &lt;#&gt; lcmap toNumber
...
`}})({reflectType:function(){return"@"}})()()(Q()(J)({reflectType:function(){return"ai0"}})({reflectSymbol:function(){return"ai0"}})),H7=ur(Dr),z7=at(),V7=Nt(dt),J7=De(Ar),G7=Ta(Fn),j7=Vo(fo(ar(wr()(St(St(Or)(zo)()()()({reflectSymbol:function(){return"q"}}))(oo)()()()({reflectSymbol:function(){return"frequency"}})))($r()()))),X7=function(){return D.value}(),DO=function(t){return function(r){return function(e){return U7(D.value)(X7)({ai0:$(bt(e)(t)(function(n){return lt(n)("https://freesound.org/data/previews/320/320873_527080-hq.mp3")})(function(n){return function(a){return ut(n)([ea(H7(a)(z7))(function(u){return function(i){return V7(.8)(J7(Ge(0)(40))(G7(Vr)(function(o){return j7({frequency:200+o*150,q:30})([u])})))}})])}}))})}}};var K7=nr({reflectType:function(){return`<div>
  <pre><code>\\buf -> run2_
  [ fix
      \\b -> gain_ 1.0
        [ playBuf buf bangOn
...
`}})()()(tw(tw(J)({reflectType:function(){return"txt"}})({reflectSymbol:function(){return"txt"}}))({reflectType:function(){return"cancel"}})({reflectSymbol:function(){return"cancel"}})),ij=Nt(dt),fj=ur(Dr),cj=me(Gt)(T),lj=at(),rw=C(nt),ew=Ma(),pj=ew(wn),_j=vo(so),sj=j(Ar),vj=ew(mT),mj=function(){return D.value}(),nw=function(t){return function(r){return function(e){return oj(mj)({txt:$(ee(`\\ctx buf -> run2 ctx
  [ gain_ 1.0
...
`}})()()(aw(aw(J)({reflectType:function(){return"txt"}})({reflectSymbol:function(){return"txt"}}))({reflectType:function(){return"envelope"}})({reflectSymbol:function(){return"envelope"}})),bj=Nt(dt),yj=ur(Dr),Aj=me(Gt)(T),kj=at(),gj=C(nt),hj=Ma()(wn),Cj=vo(so),xj=j(Ar),Tj=function(){return D.value}(),uw=function(t){return function(r){return function(e){return dj(Tj)({txt:$(ee(`\\ctx buf -> run2 ctx
  [ gain_ 1.0
      [ loopBuf buf
          OneOf.do
            bangOn
