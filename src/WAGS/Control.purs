...
--   where
--   Core.InitializeBandpass i = Common.toInitializeBandpass i'
...
--   where
--   Core.InitializeConstant i = Common.toInitializeConstant i'
...
--   where
--   Core.InitializeConvolver i = Common.toInitializeConvolver i'
...
--   where
--   Core.InitializeDelay i = Common.toInitializeDelay i'
...
--   where
--   Core.InitializeDynamicsCompressor i = Common.toInitializeDynamicsCompressor i'
--   go
--     parent
--     di@
--       ( Core.AudioInterpret
...
--   where
--   Core.InitializePlayBuf i = Common.toInitializePlayBuf i'
--   go
--     parent
--     di@
--       ( Core.AudioInterpret
